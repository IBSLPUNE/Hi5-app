...
/**
 * Generated class for the EventAllListDetailsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-event-all-list-details',
  templateUrl: 'event-all-list-details.html',
})
export class EventAllListDetailsPage {
 loading: any;
 count_data: any;
 mobile_no_count: any;
