...
/**
 * Generated class for the DailySalesProductPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-daily-sales-product',
  templateUrl: 'daily-sales-product.html',
})
export class DailySalesProductPage {
