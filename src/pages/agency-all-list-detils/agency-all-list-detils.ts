...
/**
 * Generated class for the AgencyAllListDetilsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-agency-all-list-detils',
  templateUrl: 'agency-all-list-detils.html',
})
export class AgencyAllListDetilsPage {
