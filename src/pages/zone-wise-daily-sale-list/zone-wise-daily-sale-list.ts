...
/**
 * Generated class for the ZoneWiseDailySaleListPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-zone-wise-daily-sale-list',
  templateUrl: 'zone-wise-daily-sale-list.html',
})
export class ZoneWiseDailySaleListPage {
