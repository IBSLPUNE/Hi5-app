...
/**
 * Generated class for the EmployeeAllListDetailsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-employee-all-list-details',
  templateUrl: 'employee-all-list-details.html',
})
export class EmployeeAllListDetailsPage {
