...
/**
 * Generated class for the ZoneEventPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-zone-event',
  templateUrl: 'zone-event.html',
})
    ...
    saveZoneEventData(){
     ...
     this.showLoader();
       ...
       // this.EventReq.district_type = this.district_type.value;
        ...
        this.authService.saveZoneEventData(this.EventReq).then((result) => {
             this.loading.dismiss();
            ...
            let bDismiss = false;
                ...
                this.presentToast(result["status"], bDismiss);
                 this.closeModal();
          }, (err) => {
            this.loading.dismiss();
            let errJson = err.json();
