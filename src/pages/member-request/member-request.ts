...
/**
 * Generated class for the MemberRequestPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-member-request',
  templateUrl: 'member-request.html',
})
export class MemberRequestPage {
    ...
    saveMemberData(){
     if (this.firstName == undefined) {
      ...
      this.showLoader();
        ...
        this.MemberReq.agency_type = localStorage.getItem('agency_id');
        this.MemberReq.status = true;
      
  
     
        this.authService.saveMemberData(this.MemberReq).then((result) => {
            this.loading.dismiss();
