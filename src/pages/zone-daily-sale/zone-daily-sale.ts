...
/**
 * Generated class for the ZoneDailySalePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-zone-daily-sale',
  templateUrl: 'zone-daily-sale.html',
})
export class ZoneDailySalePage {
   ...
   AgentZoneReq = {agent_id: '', distributor_type: '', sub_distributor_type: '', select_sale_type: '', primary_sell: '', seconary_sell: '', current_date: '', status: true, product_type: '', description: '', street_root: '', scheme_type: ''}
     ...
     getmemberData() {
      ...
      //  if (this.sub_distributor_type.value == '') {
       ...
       // } 
        ...
        //this.showLoader();
        var now = new Date();
        this.AgentZoneReq.select_sale_type = this.select_sale_type.value;
        this.AgentZoneReq.distributor_type = this.distributor_type.value;
        this.AgentZoneReq.street_root = this.street_root.value;
        this.AgentZoneReq.sub_distributor_type = this.sub_distributor_type.value;
        this.AgentZoneReq.product_type = this.product_type.value;
        this.AgentZoneReq.scheme_type = this.scheme_type.value;
        this.AgentZoneReq.primary_sell = this.PrimarySell;
        this.AgentZoneReq.seconary_sell = this.SecondarySell;
        this.AgentZoneReq.current_date = moment(now).format('YYYY-MM-DD');
        this.AgentZoneReq.agent_id = this.agent_id.value;
        this.AgentZoneReq.status = true;
        this.AgentZoneReq.description = this.Description;
 
        this.authService.saveZoneDailySalesRequest(this.AgentZoneReq).then((result) => {
           // this.loading.dismiss();
              this.sale_data = result;
