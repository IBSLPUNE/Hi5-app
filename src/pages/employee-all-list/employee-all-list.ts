...
import { EmployeeAllListDetailsPage } from '../employee-all-list-details/employee-all-list-details';

/**
 * Generated class for the EmployeeAllListPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-employee-all-list',
  templateUrl: 'employee-all-list.html',
})
export class EmployeeAllListPage {
 loading: any;
 member_data: any;
 ...
 showLoader() {
   ...
   showModalDialog(req_data) {
        ...
        var DetailsmodalPage = this.popoverCtrl.create(EmployeeAllListDetailsPage, data, { cssClass: 'clsPopup' });
        DetailsmodalPage.present();
    }
    showNewMemberRequest(){

        var MemberRequestPagemodalPage = this.modalCtrl.create('MemberRequestPage');
