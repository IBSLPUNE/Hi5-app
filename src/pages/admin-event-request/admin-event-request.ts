...
/**
 * Generated class for the AdminEventRequestPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-admin-event-request',
  templateUrl: 'admin-event-request.html',
})
export class AdminEventRequestPage {
 ...
 loading: any;
  ...
  // EventDate: string = '';
   ...
   EventReq = { county_type: '', state_type: '', district_type: '', event_type: '', code: '', name: '', discription: '', current_date: '', place: '', town: '', village: '', city_type: '', member_type:'', agency_id:'', select_type:'' }
  ...
  textAreaEmpty(){
   ...
   compareFn(option1: any, option2: any) {
    ...
    getCityType() {
      ...
      //  this.showLoader();
        this.authService.getAgency().then((result) => {
         //   this.loading.dismiss();
            ...
            this.agency_id = { text: 'Select SO', value: '' };
     ...
     getallmemberdetails() {
       // this.showLoader();
        this.authService.getmemberdetails(this.agency_id.value).then((result) => {
           // this.loading.dismiss();
    ...
    saveAllEventData(){
     ...
     this.showLoader();
       ...
       // this.EventReq.district_type = this.district_type.value;
        ...
        this.EventReq.agency_id = this.agency_id.value;
          
     
        this.authService.saveAllEventData(this.EventReq).then((result) => {
             this.loading.dismiss();
